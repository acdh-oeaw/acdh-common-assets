...
{  
  "elements":[
    ...
    {  
      "tag":"h1",
      "class":"error-title",
      "content":"Sorry, the service is not available!"
    },
    {  
      "tag":"p",
      "class":"error-description",
      "content":"The server is currently unavailable, because it is overloaded or down for maintenance. Generally, this is a temporary state. <br><br>We apologize for the inconvenience."
    },
    {  
      "tag":"a",
      "class":"acdh-logo",
