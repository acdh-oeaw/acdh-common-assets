...
{  
  "elements":[
    ...
    {  
      "tag":"h1",
      "class":"error-title",
      "content":"Sorry, the server is not responding!"
    },
    {  
      "tag":"p",
      "class":"error-description",
      "content":"The server was acting as a gateway or proxy and did not receive a timely response from the upstream server. <br><br>We apologize for the inconvenience."
    },
    {  
      "tag":"a",
      "class":"acdh-logo",
